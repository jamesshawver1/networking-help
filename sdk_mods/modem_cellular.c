...
//MODEM_CHAT_MATCHES_DEFINE(allow_match, MODEM_CHAT_MATCH("OK", "", NULL), MODEM_CHAT_MATCH("ERROR", "", NULL));
...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(telit_me910g1_init_chat_script_cmds,
				  ...
				  MODEM_CHAT_SCRIPT_CMD_RESP("", ok_match),
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CFUN=1", ok_match),
			          MODEM_CHAT_SCRIPT_CMD_RESP("AT+CMUX=0,0,5,122", ok_match)
			   );
#else // my code
...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(telit_me910g1_init_chat_script_cmds,
				...
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CMEE=1"   , 200),   
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT#SELINT=2" , 200), 
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CFUN=1"   , 2000),   
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CREG=1"   , 200),   
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CGREG=1"  , 200),  
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CEREG=1"  , 200),  
				MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+COPS=0"   , 1000),   

				//MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT#PPPCFG=1"   , 1000),   
				//MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT#GAUTH=3"   , 1000),   

				  //MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CGDCONT=1,\"IP\"," "\"" CONFIG_MODEM_CELLULAR_APN "\"", 2500),
				  //MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CGDCONT=1,\"IP\"," "\"" CONFIG_MODEM_CELLULAR_APN "\",,,,1,", 2500),
				  MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CGDCONT=1,\"IP\",\"h2g2\",\"8.8.8.8\",0,0,1", 2500),

				//MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT#SGACT=1,1", 1000 ),  //might be an issue?
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+ICCID", iccid_match),  
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CIMI", cimi_match),    
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CGSN", imei_match),    
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CGMM", cgmm_match),    
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CGMI", cgmi_match),    
				  MODEM_CHAT_SCRIPT_CMD_RESP("AT+CGMR", cgmr_match),    
			        MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT#CMUXMODE=5", 1000),
			        MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CMUX=0,0,5,122", 1000)
			   );
#endif
...
MODEM_CHAT_SCRIPT_CMDS_DEFINE(telit_me910g1_periodic_chat_script_cmds, 
		MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CREG?", 500), 
		MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CGREG?", 500), 
		MODEM_CHAT_SCRIPT_CMD_RESP_NONE("AT+CEREG?", 500));
